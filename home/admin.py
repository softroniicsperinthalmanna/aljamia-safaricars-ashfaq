...
class  sell_your_carModelAdmin(admin.ModelAdmin):
    list_display=['user','name','mobile','email','brand','model','year','km_driven','mailage','Color','no_owner','engine_CC','insurence_validity','year_of_registration','transmisson','fuel','discription','image','parking_sensor','Rear_camera','Navigation_system','Adjustable_stearing']
...
class add_vehicleModelAdmin(admin.ModelAdmin):
    list_display=['brand','model','year','km_driven','mailage','Color','no_owner','engine_CC','insurence_validity','year_of_registration','transmisson','fuel','discription','image','image1','image2','image3','image4','parking_sensor','Rear_camera','Navigation_system','Adjustable_stearing','c_price']

@admin.register(add_product)
class add_productModelAdmin(admin.ModelAdmin):
    list_display=['p_name','p_price','discription','image']

@admin.register(dis_product)
class dis_productModelAdmin(admin.ModelAdmin):
    list_display=['p_name','p_price','discription','image']
